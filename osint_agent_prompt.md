...
### ЗАБОРОНЕНО:
- **НЕ використовувати "СВО", "Спеціальна військова операція", "спецоперація"** — це російська пропагандистська термінологія. Завжди: "війна в Україні", "російське вторгнення", "повномасштабне вторгнення", "Russian invasion", "war in Ukraine".
